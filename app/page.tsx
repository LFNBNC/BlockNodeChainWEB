    ...
    <main className="flex min-h-screen flex-col items-right justify-center p-10">
      <div className="z-10 w-half max-w-5xl items-right justify-center font-Bold text-sm lg:flex ">
       ...
       <div className='fixed content left-10'>
          ...
          className="Border">
            <h1 className={'text-lg font-mono text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-violet-100 m-4 rounded-full bg-gradient-to-r from-violet-800 via-white-500 to-blue-500'}>
               Documentation </h1>
           </a>
          </div>
