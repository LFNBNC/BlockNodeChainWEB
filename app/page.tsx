...
export default function Home() {
  return (
    ...
    <main className="flex min-h-screen flex-col items-right justify-between p-10">
      <div className="z-10 w-half max-w-5xl items-right justify-between font-mono text-sm lg:flex">
        <p className="fixed left-0 top-0 flex w-full justify-start border-b border-violet-400 bg-gradient-to-b from-violet-200 pb-6 pt-8 backdrop-blur-2xl dark:border-neutral-800 dark:bg-zinc-800/30 dark:from-inherit lg:static lg:w-auto  lg:rounded-xl lg:border lg:bg-violet-200 lg:p-4 lg:dark:bg-zinc-800/30">
          Block Node Chain&nbsp;
